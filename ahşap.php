...
$brands_query = "SELECT DISTINCT product_brand FROM TBL_PRODUCT WHERE product_category = 'AHŞAP'";
$brands_result = mysqli_query($con, $brands_query);

$pieces_query = "SELECT DISTINCT product_pieces FROM TBL_PRODUCT WHERE product_category = 'AHŞAP'";
$pieces_result = mysqli_query($con, $pieces_query);

$prices_query = "SELECT DISTINCT product_price FROM TBL_PRODUCT WHERE product_category = 'AHŞAP'";
$prices_result = mysqli_query($con, $prices_query);

$itemsPerPage = 12;
$current_page = isset($_GET['page']) ? $_GET['page'] : 1;

$totalItemsQuery = "SELECT COUNT(*) as total FROM TBL_PRODUCT WHERE product_category = 'AHŞAP'";
...
$select_query = "SELECT * FROM TBL_PRODUCT WHERE product_category = 'AHŞAP'";
...
?>
	...
	<div class="page-info-section page-info-big">
		<div class="container">
			...
			<img src="uploads/14.PNG" width="500" height="500" alt="" class="cata-top-pic">
		</div>
	</div>
